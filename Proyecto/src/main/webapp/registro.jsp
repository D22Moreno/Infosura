<%-- 
    Document   : registro
    Created on : 26/09/2022, 9:36:59 p. m.
    Author     : DM
--%>
                            ...
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">#</th>
                                                    <th class="lista de clientes">Cliente</th>
                                                    <th>ID</th>
                                                    <th>Nombre</th>
                                                    <th>Producto</th>
                                                    <th>Cantidad</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="serial">1.</td>
                                                  <td>JOSE</td>
                                            <td> #901512528 </td>
                                            <td>  <span class="name">SURTIMAX</span> </td>
                                            <td> <span class="product">6000ML</span> </td>
                                        ...
                                        <tr>
                                            <td class="serial">2.</td>
                                                  <td> JUAN </td>
                                            <td> #901512528 </td>
                                            <td>  <span class="name">SUPERMERCADO L6</span> </td>
                                            <td> <span class="product">1000ML</span> </td>
                                        ...
                                        <tr>
                                            <td class="serial">3.</td>
                                                  <td>      </td>
                                            <td> #901512528 </td>
                                            <td>  <span class="name">CARLOS ROMERO</span> </td>
                                            <td> <span class="product">2000ML</span> </td>
