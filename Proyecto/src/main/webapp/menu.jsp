<%-- 
    Document   : menu
    Created on : 26/09/2022, 9:11:13 p. m.
    Author     : DM
--%>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>      </td>
                                                    <td> #15 </td>
                                                    <td>  <span class="name">Luis Santos</span> </td>
                                                    <td> <span class="product">1000ml</span> </td>
                                                    <td><span class="count">231</span></td>
                                                    <td>
                                                        <span class="badge badge-complete">Entregado</span>
                                                    </td>
                                                </tr>
                                                </tr>
                                            </tbody>
